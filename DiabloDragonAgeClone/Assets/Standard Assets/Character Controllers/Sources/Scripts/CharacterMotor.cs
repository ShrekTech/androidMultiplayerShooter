...
public class CharacterMotor : MonoBehaviour
{
    ...
    private void UpdateFunction()
    {
		...
		Debug.Log ("velocity after input applied: " + velocity);

        // Apply gravity and jumping force
        velocity = ApplyGravityAndJumping(velocity);

		Debug.Log ("velocity after jumping input applied: " + velocity);
		...
		Debug.Log ("shrek was here lol: " + currentMovementOffset);
